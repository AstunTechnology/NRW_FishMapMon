...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_CasHandGather_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_cas_hand_gath -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_ProHandGather_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_pro_hand_gath -s_srs "EPSG:27700" -a_srs "EPSG:27700"
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_RSA_CB_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_rsa_charterboats -s_srs "EPSG:27700" -a_srs "EPSG:27700"
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_RSA_NCB_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_rsa_noncharter -s_srs "EPSG:27700" -a_srs "EPSG:27700"
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_RSA_Shore_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_rsa_shore -s_srs "EPSG:27700" -a_srs "EPSG:27700"
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/SensitivityConfidence/FMM_Scallop_Habitats_SensvtyConf.tab" -nln sensvtyconf_lvls_scallops -s_srs "EPSG:27700" -a_srs "EPSG:27700"
