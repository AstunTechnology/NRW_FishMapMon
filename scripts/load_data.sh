...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Cas_Hand_Gath.tab" -nln intensity_lvls_cas_hand_gath_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Fixed_Pots.tab" -nln intensity_lvls_fixed_pots_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
# Ignore lines
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Foot_Access.tab" -nln intensity_lvls_foot_access_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_King_Scallops.tab" -nln intensity_lvls_king_scallops_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_LOT.tab" -nln intensity_lvls_lot_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Mussels.tab" -nln intensity_lvls_mussels_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Nets_Polygons.tab" -nln intensity_lvls_nets_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
# Ignore lines
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Pro_Hand_Gath.tab" -nln intensity_lvls_pro_hand_gath_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_Queen_Scallops.tab" -nln intensity_lvls_queen_scallops_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_RSA_CharterBoats.tab" -nln intensity_lvls_rsa_charterboats_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_RSA_Commercial.tab" -nln intensity_lvls_rsa_commercial_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_RSA_nonCharter.tab" -nln intensity_lvls_rsa_noncharter_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
...
ogr2ogr -overwrite -skipfailures -f PostgreSQL PG:'dbname=fishmap active_schema=public host=localhost user=fishmap_webapp password=<password>' "FMM_Data/Outputs/Intensity_Lvls_RSA_shore.tab" -nln intensity_lvls_rsa_shore_detailed -s_srs "EPSG:27700" -a_srs "EPSG:27700"
